...
import com.github.legioth.srp4gwt.client.resources.Srp4ClientBundle;
...
public class Srp6Client {
    ...
    static {
        TextResource resource = Srp4ClientBundle.INSTANCE.jsBinaryLibrary();
        String text = resource.getText() + (true ?
